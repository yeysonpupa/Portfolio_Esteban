...
const Timeline = () => {
    return (
        <div className="pl-8 md:pl-16 pt-8 bg-whiteBackground">
            ...
            <p className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-blackText mt-2 md:mt-4 text-justify pr-8 md:pr-16 font-bold">
            ...
            <p className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-blackText mt-2 md:mt-4 text-justify pr-8 md:pr-16 font-bold">
                {`UI/UX Designer • `}<span className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-primary mt-2 md:mt-4 text-justify pr-8 md:pr-16 font-bold">{`Code/Bits Startup`}</span>
            </p>
            <p className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-blackText mt-2 md:mt-4 text-justify pr-8 md:pr-16">
                {`As a member of the design team at Code/Bits, I have actively participated in creating high-fidelity prototypes in Figma to visualize and evaluate the user experience in detail, implementing designs that ensure an intuitive and engaging product.`}
            </p>
            <div className="flex mt-2 md:mt-4">
                <p className="font-manrope text-TextoMedianoPhone md:text-TituloNormal text-blackText pr-4 md:pr-8" style={{ whiteSpace: 'nowrap' }}>
                    Jan 2023 - Present
            ...
            <p className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-blackText mt-2 md:mt-4 text-justify pr-8 md:pr-16 font-bold">
                {`UI/UX Designer • `}<span className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-primary mt-2 md:mt-4 text-justify pr-8 md:pr-16 font-bold">{`Human-Centered Design Research Group`}</span>
            </p>
            <p className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-blackText mt-2 md:mt-4 text-justify pr-8 md:pr-16">
                {`I have immersed myself in all the stages of Design Thinking, focusing on hi-fidelity prototyping in Figma and development of technological solutions aimed at solving real-world problems.`}
            </p>
            <div className="flex mt-2 md:mt-4">
                <p className="font-manrope text-TextoMedianoPhone md:text-TituloNormal text-blackText pr-4 md:pr-8" style={{ whiteSpace: 'nowrap' }}>
                    May 2024
            ...
            <p className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-blackText mt-2 md:mt-4 text-justify pr-8 md:pr-16 font-bold">
                {`Technology and Digital Talent Trainee • `}<span className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-primary mt-2 md:mt-4 text-justify pr-8 md:pr-16 font-bold">{`SURA`}</span>
            </p>
            <p className="font-manrope text-TextoPequeñoPhone md:text-TextoNormal text-blackText mt-2 md:mt-4 text-justify pr-8 md:pr-16">
                {`Participant in the SURA Technology and Digital Training, improving the automation and self-management of technological incidents, designing and presenting a high-fidelity prototype to enhance user experience and operational efficiency.`}
            </p>
            <div className="flex mt-2 md:mt-4">
                <p className="font-manrope text-TextoMedianoPhone md:text-TituloNormal text-blackText pr-4 md:pr-8" style={{ whiteSpace: 'nowrap' }}>
                    May - Nov 2022
